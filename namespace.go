...
func (u AttributeSchemaParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.String, u.AttributeSchemaConfig)
}
...
func (r FullTextSearch) ToParam() FullTextSearchParam {
	return param.Override[FullTextSearchParam](json.RawMessage(r.RawJSON()))
}
...
func (u FullTextSearchParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.Bool, u.FullTextSearchConfig)
}
