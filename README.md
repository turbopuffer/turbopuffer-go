...
The Turbopuffer Go library provides convenient access to the [Turbopuffer REST API](https://turbopuffer.com/docs/api-overview)
...
```sh
go get -u 'github.com/turbopuffer/turbopuffer-go/v2@v2.4.0'
```
