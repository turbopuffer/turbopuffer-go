...
The turbopuffer Go library provides convenient access to the [turbopuffer HTTP API](https://turbopuffer.com/docs/api-overview)
...
```sh
go get -u 'github.com/turbopuffer/turbopuffer-go@v2.4.0'
```
